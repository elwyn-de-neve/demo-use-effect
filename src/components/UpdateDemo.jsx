    ...
    <div className="update-demo">
      ...
      <div className="demo-row">
        <div className="demo-card">
          ...
          <p>
            Deze useEffect heeft <code>[count]</code> als dependency array. Het
            effect wordt uitgevoerd bij mounting en wanneer count verandert.
          </p>
        ...
        <div className="demo-card">
          ...
          <div className="explanation">
            <p>
              De dependency array <code>[count]</code> vertelt React om het
              effect alleen opnieuw uit te voeren als <code>count</code>{" "}
              verandert.
            </p>
            <div className="dependency-rules">
              <div className="rule">
                • Als je de teller verhoogt → effect wordt uitgevoerd
              </div>
              <div className="rule">
                • Als je de naam wijzigt → effect wordt NIET uitgevoerd
              </div>
              <div className="rule">
                • Leeg array <code>[]</code> → effect wordt alleen bij mounting
                uitgevoerd
              </div>
              <div className="rule">
                • Geen array → effect wordt na ELKE render uitgevoerd
              </div>
              <div className="rule">
                • Meerdere waarden <code>[a, b]</code> → effect wordt uitgevoerd
                als één van deze waarden verandert
              </div>
            </div>
          </div>
        </div>
