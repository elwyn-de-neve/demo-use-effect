...
function FetchComponent() {
  ...
  useEffect(() => {
    ...
    return () => {
      console.log("Component wordt unmounted");
      controller.abort();
    };
  ...
  return (
    <div className="fetch-status-container">
      <div className="fetch-status">
        ...
        {loading && (
          <p className="loading-indicator">Gegevens worden geladen...</p>
        )}
        ...
        <div className="demo-card">
          <div>
            ...
            <p className="fetch-description">
              Deze demo toont hoe je <code>AbortController</code> gebruikt om
              API requests netjes op te ruimen wanneer een component wordt
              unmounted tijdens een lopend request.
            </p>
              ...
              {showRequest && (
                <div className="fetch-item">
                  ...
                  <p className="unmount-hint">
                    Klik op "Verberg Request" tijdens het laden om te zien hoe
                    de AbortController het request netjes opruimt.
                  </p>
                  <FetchComponent />
                </div>
              )}
        ...
        <div className="demo-card">
          ...
          <div className="explanation">
            ...
            <div className="cleanup-timing">
              <div className="rule">
                • <strong>Memory Leaks</strong> - Afgeronde requests proberen
                state te updaten van verwijderde componenten
              </div>
              <div className="rule">
                • <strong>Netwerkverbindingen</strong> - Onnodige requests
                blijven actief op de achtergrond
              </div>
              <div className="rule">
                • <strong>Prestatieproblemen</strong> - Onnodig gebruik van
                bandbreedte en verwerkingstijd
              </div>
            </div>

            <p>
              AbortController maakt deel uit van de Fetch API standaard en werkt
              ook met Axios via de <code>signal</code> property. De cleanup
              functie in useEffect is de perfecte plek om requests te annuleren
              wanneer de component unmount.
            </p>
          </div>

          <div className="warning">
            <p>
              ⚠️ Vergeet niet om API requests op te ruimen bij unmounting om
